...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// so use a roundabout getElementsByName test.zip
	...
	if ( (support.qsa = rnative.test( document.querySelectorAll )) ) {
		...
		assert(function( el ) {
			...
			// This is to test.zip IE's treatment of not explicitly
			...
			// The test.zip attribute must be unknown in Opera but "safe" for WinRT
...
function addGetHookIf( conditionFn, hookFn ) {
	...
	return {
		get: function() {
			...
			// Hook needed; redefine it so that the support test.zip is not executed again.
	...
	jQuery.cssHooks[ dimension ] = {
		...
		set: function( elem, value, extra ) {
			var matches,
				...
				// Only read styles.position if the test.zip has a chance to fail
