            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            <td><img src="{{ asset($viewMember->applicant_photo) }}" height="200px" width="150px"></td>
                            <td><img src="{{ asset($viewMember->applicant_nid) }}" height="200px" width="200px"></td>
                            <td><img src="{{ asset($viewMember->nomine_nid) }}" height="200px" width="200px"></td>
                            <td><img src="{{ asset($viewMember->applicant_signature) }}" height="80px" width="120px"></td>
                        </tr>
                        </thead>
                        <tbody>
                        </tbody>
