    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div style="text-align: right; margin-bottom: 0px; margin-top: 0px">
                <h5 style="margin-bottom: 0; margin-top: 0px; padding: 0"> Date :<span>{{$sheet}}</span></h5>
            </div>
            <div style="clear: both"></div>
            <hr>
        </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 style="text-align: center"><strong>Cashier Collection from {{$sheet}}</strong></h3>
                </div>
