    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h4 style="text-align: center" class="m-0 font-weight-bold text-primary">Store Sheet Info</h4>
            ...
            <div class="offset-md-2 col-md-8 card mb-4 py-3 border-left-success">
                <div class="card-body">
                    <form method="POST" action="{{ route('store-sheet-info') }}" name="room_add">
                        @csrf
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ __('Sheet No') }}<span style="color:red;">*</span></label>
                            <div class="col-md-6">
                                <input readonly type="number" class="form-control" name="sheet_no" value="{{$sheet}}" required  autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input readonly type="text" class="form-control" name="" value="{{$username->userName($Id)->name}}({{ $Id }})" required  autofocus>
                                <input  type="hidden" class="form-control" name="field_officer_id" value="{{ $Id }}" required  autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input readonly id="savings" max="10000000" min="1" type="number" class="form-control" name="savings" value="{{ $SavingsCollection }}" required  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input readonly id="loan_return" max="10000000" min="1" type="number" class="form-control" name="loan_return" value="{{ $LoanCollection}}" required  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input readonly id="service_charge" max="10000000" min="1" type="number" class="form-control" name="service_charge" value="{{$LoanService }}" required  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="additional_collection"  onblur="addBonus()" max="10000000" min="1" type="number" class="form-control" name="additional_collection"  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input readonly id="total"  max="10000000" min="1" type="number" class="form-control" name="total" value="{{ $LoanCollection+$LoanService+$SavingsCollection}}"   autofocus>
