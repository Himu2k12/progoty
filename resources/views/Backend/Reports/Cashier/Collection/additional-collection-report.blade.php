...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="card mb-4 py-3 border-bottom-info">
                <div class="card-body" style="text-align: center">
                    <h4 style="text-align: center">Collection Reports</h4>
                    @if ($errors->any())
        ...
        <div class="card shadow mb-4" id="fromTo">
            <div class="card-header py-3">
                <form action="{{url('Collection-reports')}}"  method="get">
                    @csrf
                    <div class="row">
        ...
        <div class="card shadow mb-4" id="daily" >
            <div class="card-header py-3">
                  <form action="{{url('daily-collection-reports')}}" method="get">
                    @csrf
                    <div class="row">
                        <div class="col-sm-1" style="margin: auto">
                            <div class="form-group" style="margin: auto">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        @if(isset($to) && isset($from))
                            <form action="{{url('generate-pdf-for-collection-reports')}}" method="get" target="_blank">
                                @csrf
                            ...
                            @else
                            <form action="{{url('daily-generate-pdf-for-collection-reports')}}" method="get" target="_blank">
                                @csrf
                                <input type="hidden" name="from" @if(isset($from)) value="{{$from}}" @endif>
