...
<table>
    <tr style="font-size: 1rem">
        <th>Name: </th>
        <td> {{$applicantInfo->ApplicantName($id)->applicant_name}}</td>
    </tr>
    <tr style="font-size: 1rem">
    ...
    <tr style="font-size: 1rem">
        <th>Mobile Number: </th>
        <td> {{$applicantInfo->ApplicantName($id)->mobile}}</td>
    </tr>
</table>
<h2 style="text-align: center;color: #0b2e13">Savings Deposite Statement</h2>
<div class="card-body">
