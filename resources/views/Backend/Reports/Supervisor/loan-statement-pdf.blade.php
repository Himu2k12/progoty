    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div style="width:150px; float: left;padding-top: 25px ">
                ...
                <h6 style="margin: 0; padding: 0">Office@progatybd.com</h6>
...
<table>
    <tr style="font-size: 1rem">
        <th>Name: </th>
        <td> {{$applicantInfo->ApplicantName($id->account_no)->applicant_name}}</td>
    </tr>
    <tr style="font-size: 1rem">
        <th>Account No/Member ID: </th>
        <td> {{$applicantInfo->ApplicantName($id->account_no)->id}}</td>
    </tr>
    <tr style="font-size: 1rem">
        <th>Loan ID: </th>
        <td> {{$id->id}}</td>
    ...
    <tr style="font-size: 1rem">
        <th>Mobile Number: </th>
        <td> {{$applicantInfo->ApplicantName($id->account_no)->mobile}}</td>
    </tr>
</table>
<h2 style="text-align: center;color: #0b2e13">Loan Deposite Statement</h2>
<div class="card-body">
    <div class="table-responsive">
        <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
            ...
            @foreach($statements as $statement)
                <tr>
                    <td>{{$i++}}</td>
                    <?php $name = explode(" ", $statement->created_at); ?>
