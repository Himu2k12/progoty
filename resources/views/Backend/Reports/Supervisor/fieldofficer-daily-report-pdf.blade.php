...
<h2 style="text-align: center;color: #0b2e13">Daily Field Officer's Savings Collection Statement</h2>
<div class="card-body">
    <div class="table-responsive">
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            @foreach($savings as $data)
                <tr>
                    ...
                    <td>{{$foN->userName($data->field_man_id)->name}}</td>
                    <td>{!! $data->amount !!}</td>
                </tr>
        ...
        <h2 style="text-align: center;color: #0b2e13">Daily Field Officer's Loan Collection Statement</h2>
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            <thead style="">
            <tr style="font-size: .85rem">
                <th>Collection ID</th>
