...
<h2 style="text-align: center;color: #0b2e13">Field Officer's Savings Collection Statement</h2>
<div class="card-body">
    <div class="table-responsive">
        ...
        <h2 style="text-align: center;color: #0b2e13">Field Officer's Loan Collection Statement</h2>
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            <thead style="">
            <tr style="font-size: .85rem">
                <th>Collection ID</th>
