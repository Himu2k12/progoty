...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            ...
            <div style="float: left">
                <h3 style="color: #0b2e13; margin-bottom: 0px; margin-top: 0px">Daily Report</h3>
            </div>

            <div style="text-align: right; margin-bottom: 0px; margin-top: 0px">
                <h5 style="margin-bottom: 0; margin-top: 0px; padding: 0"> From :<span>{{$date}}</span></h5>
            </div>
            <div style="clear: both"></div>
            <hr>
        </div>
...
<h2 style="text-align: center;color: #0b2e13">Additional Collection</h2>
<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
    <thead>
    <tr style="text-align: center">
        <th>SL NO</th>
...
<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
    ...
    <tr>
        ...
        <td >{{$totalLoanDate}}</td>
        <td >{{$totalSum}}</td>
        <td >{{$totalServiceDate}}</td>
        <td >{{$totalSavings+$totalLoanDate+$totalSum+$totalServiceDate}}</td>
        <td ></td>
    </tr>
    </tbody>
</table>
