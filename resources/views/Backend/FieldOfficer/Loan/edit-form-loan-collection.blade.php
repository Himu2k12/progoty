        ...
        <div class="col-lg-6 offset-3">
            <div class="card shadow mb-4 border-bottom-info">
                <div class="card-header py-3">
                    <h4 class="text-primary" style="text-align: center; ">Edit Loan Info</h4>
                ...
                <div class="card-body row">
                    <div class="col-md-12">
                        <form method="POST" action="{{ url('/update-daily-loan-deposites') }}">
                            @csrf
                            <div class="form-group row">
                                <label for="savingsInfo" class="col-md-4 col-form-label newLevel">{{ __('Selected ID') }}</label>
                                <div class="col-md-6" >
                                    <input type="number" class="form-control" name="amount" value="{{$updateInfo->account_no}}" disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="amount" type="number" class="form-control{{ $errors->has('amount') ? ' is-invalid' : '' }}" name="amount" value="{{$updateInfo->amount}}" min="0" max="1000000" required autofocus>
                            ...
                            <div class="form-group row">
                                <label for="sheetNo" class="col-md-4 col-form-label newLevel" >{{ __('Service Charge') }}</label>

                                <div class="col-md-6">
                                    <input id="serviceCharge" type="number" class="form-control{{ $errors->has('service_charge') ? ' is-invalid' : '' }}" name="service_charge" value="{{$updateInfo->service_charge }}" min="1" max="10000000" required autofocus>
