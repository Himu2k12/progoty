            ...
            <div class="col-lg-12">
                <div class="card-body">
                    <div class="col-md-12">
                        ...
                        <div class="row" >
                            @if(\Illuminate\Support\Facades\Auth::user()->role==2 || \Illuminate\Support\Facades\Auth::user()->role==1)
                                <div class="col-sm-3 offset-2">
                                    <a href="{{ url('/verify-members/'.$viewMember->id) }}" class="btn btn-success btn-lg" title="Confirm Verification">
                                        <span class="fas fa-check"> Verify</span>
                                    </a>
                                </div>
                                <div class="col-sm-3 offset-3">
                                    <a href="{{ url('/decline-members/'.$viewMember->id) }}" onclick="return confirm('Are you sure to Decline the new member?')" class="btn btn-danger btn-lg" title="Decline Verification">
                                        <i class="fas fa-trash"> Decline</i>
                                    </a>
                                </div>
                            @endif
                        </div>
