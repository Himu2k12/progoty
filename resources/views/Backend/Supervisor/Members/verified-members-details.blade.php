    ...
    <div class="container-fluid">
        <div class="col-lg-12">
            <div class="card mb-4 py-3 border-bottom-info">
                <div class="card-body">
                    <h4 style="text-align: center">Verified Member Details</h4>
                    ...
                    <div class="col-md-12">
                        <nav class="divstyle border-bottom-success">
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" id="nav-documents-tab" data-toggle="tab" href="#nav-verification" role="tab" aria-controls="nav-assignation" aria-selected="false">Verification</a>
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="card-body row table-responsive">
                                        <table width="100%" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$upazila->upazilaName($viewMember->permanent_upa)->upazila_name }}</td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="card-body row table-responsive">
                                        <table width="100%" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$upazila->upazilaName($viewMember->nominee_upazila)->upazila_name }}</td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="tab-pane fade" id="nav-verification" role="tabpanel" aria-labelledby="nav-contact-tab">
                                <div class="card shadow mb-12">
                                    <div class="card-header py-12">
                                        <div>
                                            <h6 class="m-0 font-weight-bold text-primary">Verification Info</h6>
                                        </div>
                                    </div>
                                    <div class="card-body row table-responsive">
                                        <table width="100%" class="table table-striped table-bordered table-hover">
                                            <tr>
                                                <th style="text-align: center;vertical-align: middle;">Supervisor Name</th>
                                                <td>{{$verificationDetails->name}}</td>
                                            </tr>
                                            <tr>
                                                <th style="text-align: center;vertical-align: middle;">Supervisor ID</th>
                                                <td>{{$verificationDetails->SupervisorId}}</td>
                                            </tr>
                                            <tr>
                                                <th style="text-align: center;vertical-align: middle;">Verification Time</th>
                                                <td>{{$verificationDetails->created_at}}</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
