                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-sm-3 offset-3">
                                <a href="{{ url('/view-loan-document-upload/'.$loanInfo->slug) }}" class="btn btn-success btn-lg" title="Confirm Verification">
                                    <i class="fas fa-check"> Approve</i>
                                </a>
                            </div>
                            <div class="col-sm-3 offset-1">
                                <a href="{{ url('/cancel-loan-by-supervisor/'.$loanInfo->slug) }}" onclick="return confirm('Are you sure to Cancel the Loan?')" class="btn btn-danger btn-lg" title="Decline Verification">
