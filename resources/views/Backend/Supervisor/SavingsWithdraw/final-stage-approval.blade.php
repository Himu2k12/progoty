                                                ...
                                                <div class="col-sm-6 offset-3" style="margin-bottom: 20px">
                                                    <fieldset class="field_border" >
                                                        ...
                                                        <div class="col-sm-12" style=" margin-bottom: 20px">
                                                            ...
                                                            <input readonly type="text" class="form-control"  name="savings_amount" value="{{$SumofMoney}}" required minlength="4">
                                                        ...
                                                        <div class="col-sm-12" style=" margin-bottom: 20px">
                                                            <label class="required">Withdrawn Amount(উত্তলিত অর্থ)</label>
                                                            <input readonly type="text" class="form-control" name="savings_amount" value="{{$SumofTotalWithdrawMoney}}" required minlength="4">
                                                        </div>
                                                        <div class="col-sm-12" style=" margin-bottom: 20px">
                                                        <label class="required">Current Amount(বর্তমান অর্থ)</label>
                                                            <input readonly type="text" class="form-control" id="savings_amount" name="current_amount" value="{{$currentBalance}}" required minlength="4">
                                                        </div>
                                                        <div class="col-sm-12" style=" margin-bottom: 20px">
                                                        <label class="required">Partial Request Amount(আংশিক উত্তলোন  পরিমাণ)</label>
                                                            <input readonly type="text" class="form-control" id="savingsAmount" name="" value="{{$allInfo->total_savings}}" required minlength="4">
                                                        </div>
                                                        <div class="col-sm-12" style=" margin-bottom: 20px">
