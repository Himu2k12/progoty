    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="card mb-4 py-3 border-bottom-info">
                <div class="card-body">
                    <h4 style="text-align: center">Edit Final Check on Savings Withdraw</h4>
                            ...
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                <div class="card shadow mb-12">
                                    <div class="card-header py-12">
                                        <div>
                                            <h6 class="m-0 font-weight-bold text-primary">Edit Confirmation Form</h6>
                                        </div>
                                    </div>
                                    <div class="card-body row table-responsive">
                                        <form style="border: 1px solid #bbbbbb; padding: 20px" enctype="multipart/form-data" name="editsavingsWithdraw" action="{{url('/update-submit-to-super')}}" method="post">
                                            {{csrf_field()}}
                                            <div class="row">
                                                <div class="col-sm-6 offset-3" style="margin-bottom: 20px">
                                                    <fieldset class="field_border" >
                                                        ...
                                                        <div class="col-sm-12" style=" margin-bottom: 20px">
                                                            <label class="required">Scheme<span style="color: red">*</span> (স্কিম)</label>
                                                            <select required onchange="profitCalculation()" id="scheme" name="scheme_year" class="form-control">
                                                                @foreach($schemes as $scheme)
                                                                    <option value="{{$scheme->percentage}}">{{$scheme->title}}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-sm-12" style=" margin-bottom: 20px">
                                                        <label class="required">Current Amount(বর্তমান অর্থ)</label>
                                                            <input readonly type="text" class="form-control" id="savingsAmount" name="savings_amount" value="{{$currentBalance}}" required minlength="4">
                                                        </div>
                                                        
                                                        <div class="col-sm-12" style=" margin-bottom: 20px">
                                                            <label class="required">Profit<span style="color: red">*</span> (লভ্যাংশ)</label>
                                                            <input id="profit" readonly name="profit" min="0" type="number" class="form-control" value="{{$editInfo->profit}}" >
                                                            <span  id="error_nationality" style="color: red;">{{ $errors->has('other_document') ? $errors->first('other_document') : ' ' }}</span>
                                                        </div>
                                                        <div class="col-sm-12" style=" margin-bottom: 20px">
                                                            <label class="required">Bonus(বোনাস)</label>
                                                            <input id="bonus" onblur="addBonus()" name="bonus" value="{{$editInfo->bonus}}" type="number" class="form-control" >
                                                        ...
                                                        <div class="col-sm-12" style=" margin-bottom: 20px">
                                                            ...
                                                            <input id="total_money" required min="0" name="total" type="number" value="{{$editInfo->total}}" class="form-control" >
                                                            <input name="U_ID" type="hidden" value="{{$editInfo->id}}" >
                                                            <span  id="error_total_money" style="color: red;">{{ $errors->has('total_money') ? $errors->first('total_money') : ' ' }}</span>
                                                        </div>
        ...
        <script>
            document.forms['editsavingsWithdraw'].elements['scheme_year'].value = '{{ $editInfo->percentage }}';
            ...
            function profitCalculation(){
                ...
                var profit= savingsAmount*(year/100)
