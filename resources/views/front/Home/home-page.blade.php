...
@section('content')
    <div class="swiper-container hero-slider " data-ride="carousel">
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active swiper-slide hero-content-wrap">
                    <img src="{{asset('asset/')}}/images/hero.jpg" alt="">
                            ...
                            <div class="row h-100">
                                <div class="col-12 col-lg-8 d-flex flex-column justify-content-center align-items-start">
                                    <header class="entry-header">
                                        <h1></h1>
                                        <h4>@lang('home.progoty_name')</h4>
                                    </header><!-- .entry-header -->

                                    <div class="entry-content mt-4">
                                        <p>@lang('home.progoty_dialogue')</p>
                                    </div><!-- .entry-content -->
                ...
                <div class="item swiper-slide hero-content-wrap">
                    <img src="{{asset('asset/')}}/images/hero.jpg" alt="">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 mt-4 order-1 order-lg-2">
                    <img src="{{asset('asset/')}}/images/welcome.jpg" alt="welcome">
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
    </div><!-- .home-page-icon-boxes -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="upcoming-events">
                        ...
                        <div class="event-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="{{asset('asset/')}}/images/event-1.jpg" alt="">
                            </figure>
                        ...
                        <div class="event-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="{{asset('asset/')}}/images/event-2.jpg" alt="">
                            </figure>
                        ...
                        <div class="event-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="{{asset('asset/')}}/images/event-3.jpg" alt="">
                            </figure>
                ...
                <div class="col-12 col-lg-6">
                    <div class="featured-cause">
                        ...
                        <div class="cause-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="{{asset('asset/')}}/images/featured-causes.jpg" alt="">
                            </figure>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="{{asset('asset/')}}/images/cause-1.jpg" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="{{asset('asset/')}}/images/cause-2.jpg" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="cause-wrap">
                                    <figure class="m-0">
                                        <img src="{{asset('asset/')}}/images/cause-3.jpg" alt="">
