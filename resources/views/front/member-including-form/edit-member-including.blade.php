...
@section('content')
    ...
    <div class="welcome-wrap">
        <div class="container">
            <div class="row">
                <div class=" col-sm-12">
                    <div class="alert alert-success"><h4 style="text-align: center">Edit Application Form (আবেদন ফর্ম সম্পাদনা করুন)</h4></div>
                    <div class="" style="border: 1px solid #CDCCCC; padding: 30px">
                        ...
                        <form enctype="multipart/form-data" name="updateMember" action="{{url('/update-member')}}" method="post">
                            @if(Session::get('mass')!=null)
                                <div class="alert alert-success" style="padding: 10px"><p style="text-align: center; color: black;font-size: 12px"> {{ Session::get('mass') }}</div>
                            @endif
                            {{csrf_field()}}
                            <div class="row">
                                <div class="col-sm-6" style=" margin-bottom: 20px">
                                    <label class="required">Applicant's Full Name<span style="color: red">*</span> (আবেদনকারীর পূর্ণ নাম)</label>
                                    <input type="text" onkeyup="validate()" class="form-control" id="applicant_name" name="applicant_name" value="{{$EditmemberDetails->applicant_name}}" required minlength="4">
                                    <input type="hidden" name="id" value="{{$EditmemberDetails->id}}" >
                                ...
                                <div class="col-sm-6" style=" margin-bottom: 20px">
                                    ...
                                    <input type="text" onkeyup="validate2()" id="applicants_father_name" class="form-control" name="applicants_father_name" value="{{$EditmemberDetails->applicants_father_name}}" required minlength="4">
                                ...
                                <div class="col-sm-6" style=" margin-bottom: 20px">
                                    ...
                                    <input type="text"  onkeyup="validate3()" id="national_id" class="form-control" name="national_id" value="{{$EditmemberDetails->national_id}}" pattern="\d*[1-9]{1}[0-9]{9,19}" required>
                                ...
                                <div class="col-sm-6" style=" margin-bottom: 20px">
                                    <label class="required">Mobile Number<span style="color: red">*</span> (মোবাইল নম্বর)</label>
                                    <input id="mobile" name="mobile" onkeyup="validateMobile()" type="text" value="{{$EditmemberDetails->mobile}}" class="form-control" minlength="11" maxlength="11">
                                    <span  id="error_mobile" style="color: red;">{{ $errors->has('mobile') ? $errors->first('mobile') : ' ' }}</span>
                                </div>
                                <div class="col-sm-6 " style=" margin-bottom: 20px">
                                ...
                                <div class="col-sm-6" style=" margin-bottom: 20px">
                                    ...
                                    <input type="text" class="form-control" id="husband_name" value="{{$EditmemberDetails->husband_name}}" name="husband_name">
                                ...
                                <div class="col-sm-12" style="margin-bottom: 20px">
                                    <fieldset class="field_border" >
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            ...
                                            <input type="number" min="0" class="form-control" name="amount_of_money" value="{{$EditmemberDetails->amount_of_money}}" step="1">
                                ...
                                <div class="col-sm-12" style="margin-bottom: 20px">
                                    <fieldset class="field_border">
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            ...
                                            <input class="form-control" id="present_dist" name="present_dist" value="{{$EditmemberDetails->present_dist}}" style="height:34px;"/>
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            ...
                                            <input class="form-control" id="present_upazila" name="present_upa" value="{{$EditmemberDetails->present_upa}}" style="height:34px;"/>
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            ...
                                            <input type="number" id="present_post_code" class="form-control" name="present_post_code" value="{{$EditmemberDetails->present_post_code}}">
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            ...
                                            <input type="text" id="present_village" class="form-control" name="present_village" value="{{$EditmemberDetails->present_village}}">
                                    ...
                                    <fieldset class="field_border">
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            ...
                                            <select class="form-control" id="permanent_upa" name="permanent_upa" style="height:34px;">
                                                @foreach($permanentAdressUpazilas as $item)
                                                    <option value="{{$item->id}}">{{$item->upazila_name}}</option>
                                                    @endforeach
                                            </select>
                                ...
                                <div class="col-sm-12" style="margin-bottom: 20px">
                                    <fieldset class="field_border">
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            ...
                                            <input type="text" class="form-control" name="nominee_name" value="{{$EditmemberDetails->nominee_name}}">
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            ...
                                            <input type="text" class="form-control" name="relation" value="{{$EditmemberDetails->relation}}">
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            ...
                                            <select class="form-control" name="nominee_upazila" id="nominee_upazila" style="height:34px;">
                                                @foreach($NomineeUpazilas as $item)
                                                    <option value="{{$item->id}}">{{$item->upazila_name}}</option>
                                                    @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            <label class="required">Post Code<span style="color: red">*</span> (পোস্ট কোড)</label>
                                            <input type="number" class="form-control" name="nominee_post_code"  value="{{$EditmemberDetails->nominee_post_code}}">
                                            <span  id="error_nominee_post_code" style="color: red;">{{ $errors->has('nominee_post_code') ? $errors->first('nominee_post_code') : ' ' }}</span>

                                        </div>
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            <label class="required">Village/Road No/House No/Address <span style="color: red">*</span>(গ্রাম/রোড নং/বাড়ি নং/ঠিকানা)</label>
                                            <input type="text" class="form-control" name="nominee_address"  value="{{$EditmemberDetails->nominee_address}}">
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            ...
                                            <img src="{{asset($EditmemberDetails->nomine_nid)}}" height="80px" width="100px">
                                    ...
                                    <fieldset class="field_border">
                                        ...
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            ...
                                            <img src="{{asset($EditmemberDetails->applicant_photo)}}" height="80px" width="100px">
                                            <span  id="error_applicant_photo" style="color: red;">{{ $errors->has('applicant_photo') ? $errors->first('applicant_photo') : ' ' }}</span>

                                            <img id="blah" src="#" alt="your image" />
                                        </div>
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            <label class="required">NID<span style="color: green">*</span> (জাতীয় পরিচয়পত্র)</label>
                                            <input type='file' name="applicant_nid" onchange="readURL2(this)" />
                                            <img src="{{asset($EditmemberDetails->applicant_nid)}}" height="80px" width="100px">
                                            <span  id="error_applicant_nid" style="color: red;">{{ $errors->has('applicant_nid') ? $errors->first('applicant_nid') : ' ' }}</span>
                                            <img id="nid" src="#" alt="your image" />
                                        </div>
                                        <div class="col-sm-6" style=" margin-bottom: 20px">
                                            <label class="required">Signature<span style="color: green">*</span> (স্বাক্ষর)</label>
                                            <input type='file' name="applicant_signature" onchange="signature(this)" />
                                            <img src="{{asset($EditmemberDetails->applicant_signature)}}" height="80px" width="100px">
                                            <span  id="error_applicant_signature" style="color: red;">{{ $errors->has('applicant_signature') ? $errors->first('applicant_signature') : ' ' }}</span>
                                            <img id="signatu" src="#" />
                                        </div>
                                    </fieldset>
                                </div>
                                <div class="col-sm-12" style="margin-bottom: 20px">
                                    <div class="col-sm-2 offset-sm-5" style=" margin-bottom: 20px">
...
@section('additional_script')
    <script>
        document.forms['updateMember'].elements['gender'].value = "{{$EditmemberDetails->gender}}";
        document.forms['updateMember'].elements['religion'].value = "{{$EditmemberDetails->religion}}";
        document.forms['updateMember'].elements['marital_status'].value = "{{$EditmemberDetails->marital_status}}";
        document.forms['updateMember'].elements['yearly_scheme'].value = "{{$EditmemberDetails->yearly_scheme}}";
        document.forms['updateMember'].elements['deposite_type'].value = "{{$EditmemberDetails->deposite_type}}";
        document.forms['updateMember'].elements['present_post_code'].value = "{{$EditmemberDetails->present_post_code}}";
        document.forms['updateMember'].elements['present_village'].value = "{{$EditmemberDetails->present_village}}";
        document.forms['updateMember'].elements['permanent_post_code'].value = "{{$EditmemberDetails->permanent_post_code}}";
        document.forms['updateMember'].elements['permanent_dist'].value = "{{$EditmemberDetails->permanent_dist}}";
        document.forms['updateMember'].elements['permanent_upa'].value = "{{$EditmemberDetails->permanent_upa}}";
        document.forms['updateMember'].elements['permanent_village'].value = "{{$EditmemberDetails->permanent_village}}";
        document.forms['updateMember'].elements['relation'].value = "{{$EditmemberDetails->relation}}";
        document.forms['updateMember'].elements['nominee_post_code'].value = "{{$EditmemberDetails->nominee_post_code}}";
        document.forms['updateMember'].elements['nominee_address'].value = "{{$EditmemberDetails->nominee_address}}";
        document.forms['updateMember'].elements['nominee_address'].value = "{{$EditmemberDetails->nominee_address}}";
