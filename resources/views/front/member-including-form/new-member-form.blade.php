            ...
            <div class="row">
                <div class=" col-sm-12">
                    ...
                    @if(Session::get('mass')!=null)
                               <div class="alert alert-success" style="padding: 10px"><h4 style="text-align: center; color: black;font-size: 12px"> {{ Session::get('mass') }}</h4></div>
                           @endif
                       ...
                       <form enctype="multipart/form-data" name="newMember" action="{{url('/add-member')}}" method="post">
                           ...
                           <div class="col-sm-6" style=" margin-bottom: 20px">
                               ...
                               <div class="col-sm-6" style=" margin-bottom: 20px">
                                   ...
                                   <input id="mobile" name="mobile" onkeyup="validateMobile()" type="text" value="{{old('mobile')}}" class="form-control" minlength="11" maxlength="11" value="">
                           ...
                           <div class="col-sm-12" style="margin-bottom: 20px">
                               <fieldset class="field_border" >
                                   ...
                                   <div class="col-sm-6" style=" margin-bottom: 20px">
                                       ...
                                       <input type="number" min="0" class="form-control" name="amount_of_money" value="{{old('amount_of_money')}}" step="1">
                           ...
                           <div class="col-sm-12" style="margin-bottom: 20px">
                               <fieldset class="field_border">
                                   ...
                                   <div class="col-sm-6" style=" margin-bottom: 20px">
                                       ...
                                       <input type='file' name="nomine_nid" onchange="readURLNominee(this)"  />
                                       <span  id="error_nominee_nid" style="color: red;">{{ $errors->has('nomine_nid') ? $errors->first('nomine_nid') : ' ' }}</span>
                                       <img id="nominee" src="#" alt="your image" />
                                   </div>
                                </fieldset>
                               <fieldset class="field_border">
                                   ...
                                   <div class="col-sm-6" style=" margin-bottom: 20px">
                                       ...
                                       <img id="signatu" src="#" alt="Signature" />
                                   </div>
                               </fieldset>
                           </div>
                           <div class="col-sm-12" style="margin-bottom: 20px">
...
@section('additional_script')
    <script>
        ...
        document.forms['newMember'].elements['nominee_dist'].value = "{{old('nominee_dist')}}";
